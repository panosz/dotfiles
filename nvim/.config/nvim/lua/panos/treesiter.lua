...
configs.setup({
	ensure_installed = { "c", "cpp", "python", "html", "lua", "vue", "latex", "markdown", "markdown_inline", "vimdoc" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
