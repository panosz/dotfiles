...
-- UI{{{
    ...
    lazyredraw=false,                                -- redraw only when we need to.
    ...
    laststatus=3,                                   -- always display a single status bar at the bottom
    mouse="a",                                      -- enable mouse for scrolling and resizing
    autochdir=false,                                 -- change the current working directory whenever you open a file, switch buffers, delete a buffer or open/close a window.
